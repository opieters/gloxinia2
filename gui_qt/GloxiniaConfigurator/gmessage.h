...
public:
    ...
    GMessage(GMessage::Code code, quint8 messegaID, quint16 sensorID, bool request=false, quint8* data = nullptr, uint64_t size = 0);
    GMessage(GMessage::Code code, quint8 messegaID, quint16 sensorID, bool request, std::vector<quint8> data);
