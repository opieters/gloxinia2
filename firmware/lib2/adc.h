...
#define ADC_MAX_BUFFER_LENGTH         200
#define ADC_TX_BUFFER_LENGTH          2
...
extern "C" {
    ...
    extern unsigned int adc_tx_buffer[ADC_TX_BUFFER_LENGTH] __attribute__((space(dma), eds));
    
    extern unsigned int adc_rx_buffer_a[ADC_MAX_BUFFER_LENGTH] __attribute__((space(dma), eds));
    extern unsigned int adc_rx_buffer_b[ADC_MAX_BUFFER_LENGTH] __attribute__((space(dma), eds));
    ...
    int16_t adc_run_calibration(adc_config_t* config,  const uint16_t ref);
